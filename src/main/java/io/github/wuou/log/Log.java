...
public class Log {
    ...
    public static void variableInfo(String className, String methodName,Integer pointIndex, String variableName, String value){
        println("类名["+className+"],"+"方法名["+methodName+"],"+"断点索引"+pointIndex+"处变量["+variableName+"]"+"="+value, null, LogLevel.info);
    }
